...
public class ParticipantService {
    ...
    public void updateScore(String quizId, String username, int score) {
        Participant participant = participantRepo.findByQuizIdAndUsername(quizId, username)
                .orElseThrow(() -> new RuntimeException("Participant not found"));

        participant.setScore(score);
        participant.set(System.currentTimeMillis()); // to break ties
